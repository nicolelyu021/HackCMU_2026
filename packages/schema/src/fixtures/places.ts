...
export const mockPlaces: Place[] = [
  ...
  },
  {
    ...
    address: '117 Sandusky St, Pittsburgh, PA',
    lat: 40.44837,
    lng: -80.0025,
    category: 'museum',
  },
  ...
  },
  {
    ...
    address: '1220 Grandview Ave, Pittsburgh, PA',
    lat: 40.4394,
    lng: -80.0186,
    category: 'attraction',
  },
  ...
  },
  {
    ...
    name: 'Schenley Park',
    address: 'Schenley Dr, Pittsburgh, PA',
    lat: 40.4374,
    lng: -79.9433,
    category: 'park',
  },
  {
    place_id: 'mock:carnegie-museum-natural-history',
  ...
  {
    place_id: 'mock:carnegie-mellon-university',
  ...
  {
    place_id: 'mock:mattress-factory',
    name: 'Mattress Factory',
    address: '509 Jacksonia St, Pittsburgh, PA',
    lat: 40.457,
    lng: -80.0107,
    category: 'museum',
  },
  {
    place_id: 'mock:pamelas-diner-strip',
    name: "Pamela's Diner (Strip District)",
    address: '60 21st St, Pittsburgh, PA',
    lat: 40.4523,
    lng: -79.986,
    category: 'restaurant',
  },
  {
    place_id: 'mock:gaucho-parrilla',
    name: 'Gaucho Parrilla Argentina',
    address: '146 6th St, Pittsburgh, PA',
    lat: 40.4432,
    lng: -80.0029,
    category: 'restaurant',
  },
  {
    place_id: 'mock:mount-washington-overlook',
  ...
  {
    place_id: 'mock:frick-park',
    name: 'Frick Park',
    address: 'Beechwood Blvd, Pittsburgh, PA',
    lat: 40.438,
    lng: -79.905,
    category: 'park',
  },
  {
    place_id: 'mock:pnc-park',
    name: 'PNC Park',
    address: '115 Federal St, Pittsburgh, PA',
    lat: 40.4469,
    lng: -80.0057,
    category: 'stadium',
  },
  {
    place_id: 'mock:heinz-history-center',
  ...
  {
    place_id: 'mock:schenley-plaza',
    name: 'Schenley Plaza',
    address: '4100 Forbes Ave, Pittsburgh, PA',
    lat: 40.4426,
    lng: -79.953,
    category: 'park',
  },
  {
    place_id: 'mock:the-porch-at-schenley',
    name: 'The Porch at Schenley',
    address: '221 Schenley Dr, Pittsburgh, PA',
    lat: 40.4424,
    lng: -79.9526,
    category: 'restaurant',
  },
  {
    place_id: 'mock:pittsburgh-pa',
    name: 'Pittsburgh, PA',
    address: 'Pittsburgh, Allegheny County, Pennsylvania',
    lat: 40.4406,
    lng: -79.9959,
    category: 'city',
  },
