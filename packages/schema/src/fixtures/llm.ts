      ...
      stops: [
        {
          ...
          search_query: 'Carnegie Museum of Natural History',
          kind: 'poi',
          start_time: '10:00',
          end_time: '12:00',
          reason: 'Dinosaur hall is the best in the country and it is next to the Cathedral.',
        },
        {
          name: 'The Porch at Schenley',
          search_query: 'The Porch at Schenley',
          kind: 'food',
          start_time: '12:15',
          end_time: '13:15',
          reason: 'Wood-fired pizza on the plaza, ten minutes from the museum.',
        },
        {
          name: 'Cathedral of Learning',
          search_query: 'Cathedral of Learning',
          kind: 'poi',
          start_time: '13:30',
          end_time: '14:30',
          reason: 'Free 36th-floor view over Oakland.',
        },
        {
          name: 'Skyline Sky Lounge',
          search_query: 'Skyline Sky Lounge Pittsburgh',
          kind: 'poi',
          start_time: '15:00',
          end_time: '16:00',
          reason:
            'Rooftop bar with a view (this place is invented on purpose: it must be dropped).',
        },
        {
          name: 'Mount Washington Overlook',
          search_query: 'Mount Washington Overlook',
          kind: 'poi',
          start_time: '18:00',
          end_time: '19:30',
          reason: 'Sunset over the three rivers.',
        },
      ],
    },
    {
      ...
      stops: [
        {
          name: "Pamela's Diner",
          search_query: "Pamela's Diner (Strip District)",
          kind: 'food',
          start_time: '09:00',
          end_time: '10:00',
          reason: 'Crêpe-style hotcakes; the Strip is at its best on a weekend morning.',
        },
        {
          name: 'Heinz History Center',
          search_query: 'Heinz History Center',
          kind: 'poi',
          start_time: '10:15',
          end_time: '12:00',
          reason: 'Smithsonian affiliate two blocks from breakfast.',
        },
        {
          name: 'Randyland',
          search_query: 'Randyland',
          kind: 'poi',
          start_time: '13:00',
          end_time: '14:00',
          reason: 'Free, colourful, ten minutes from the Mattress Factory.',
        },
        {
          name: 'Mattress Factory',
          search_query: 'Mattress Factory',
          kind: 'poi',
          start_time: '14:15',
          end_time: '16:00',
          reason: 'Room-sized installations; the Kusama rooms are the reason people go.',
        },
      ],
    },
    {
      ...
      stops: [
        {
          name: 'Frick Park',
          search_query: 'Frick Park',
          kind: 'poi',
          start_time: '10:00',
          end_time: '12:00',
          reason: 'Biggest park in the city, easy trails.',
        },
        {
          name: 'Phipps Conservatory',
          search_query: 'Phipps Conservatory',
          kind: 'poi',
          start_time: '13:00',
          end_time: '15:00',
          reason: 'Glasshouse next to Schenley Park.',
        },
        {
          name: 'PNC Park',
          search_query: 'PNC Park',
          kind: 'poi',
          start_time: '18:00',
          end_time: '21:00',
          reason: 'Best view of any ballpark in the majors.',
        },
      ],
    },
  ];
