  ...
  return {
    ...
    segments: [
      ...
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_01', kenburns: 'zoom_in' },
          { media_id: 'media_pgh_02', kenburns: 'pan_left' },
        ],
        narration:
          'We started at the Cathedral of Learning and rode the elevator to the 36th floor. Every Nationality Room downstairs felt like a different century.',
      ...
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_03', kenburns: 'zoom_out' },
          { media_id: 'media_pgh_04', kenburns: 'zoom_in' },
        ],
        narration:
          'Phipps next, with three dollars extra for the fern room. Worth it, even with fogged-up glasses.',
      ...
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_05', kenburns: 'zoom_in' },
          { media_id: 'media_pgh_06', kenburns: 'pan_right' },
        ],
        narration:
          "Lunch was a Primanti's sandwich with the fries stacked inside. Half of it ended up on the tray, no regrets.",
        caption: 'Primanti Bros. · 13:27',
        mood: 'good',
      ...
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_07', kenburns: 'pan_left' },
          { media_id: 'media_pgh_08', kenburns: 'zoom_out' },
        ],
        narration:
          'At the Warhol we spent twenty minutes in the Silver Clouds room, batting the balloons around.',
      ...
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_09', kenburns: 'zoom_in' },
          { media_id: 'media_pgh_10', kenburns: 'pan_right' },
        ],
        narration:
          'Then Point State Park: one bench by the fountain, watching the three rivers meet, zero plans.',
        caption: 'Point State Park · 17:15',
        mood: 'good',
        source_entry_ids: ['entry_pgh_05'],
        audio_path: seg(5),
        duration_s: 5.5,
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_11', kenburns: 'zoom_out' },
          { media_id: 'media_pgh_12', kenburns: 'zoom_in' },
          { media_id: 'media_pgh_13', kenburns: 'pan_left' },
        ],
        narration:
          'We ended with the Duquesne Incline creaking the whole way up to Grandview for sunset. Perfect.',
        caption: 'Grandview overlook · 18:50',
        mood: 'great',
        source_entry_ids: ['entry_pgh_06'],
        audio_path: seg(6),
        duration_s: 6.5,
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_14', kenburns: 'zoom_in' },
          { media_id: 'media_pgh_15', kenburns: 'pan_right' },
          { media_id: 'media_pgh_16', kenburns: 'zoom_out' },
        ],
        narration:
          'Day two began with pastries in the Strip District, then twenty-four hours of code at HackCMU.',
        caption: 'Strip District · 09:20',
        mood: 'tired',
        source_entry_ids: ['entry_pgh_07'],
        audio_path: seg(7),
        duration_s: 5.5,
      },
      {
        ...
        photos: [
          { media_id: 'media_pgh_19', kenburns: 'zoom_in' },
          { media_id: 'media_pgh_20', kenburns: 'pan_right' },
          { media_id: 'media_pgh_21', kenburns: 'zoom_out' },
        ],
        narration:
          'On The Cut: Ferris wheel, a pirate skeleton pouring drinks, a pink Eras Tour booth. Then twenty-four hours of code.',
        caption: 'Carnegie Mellon · Carnival · 12:10',
        mood: 'great',
        source_entry_ids: ['entry_pgh_08'],
        audio_path: seg(8),
        duration_s: 6,
      },
      {
