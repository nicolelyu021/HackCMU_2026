...
/**
 * 21 demo photos (19 assigned, 2 tray). Seed stamps GPS + DateTimeOriginal and copies into
 * packages/schema/fixtures/photos/<id>.jpg, then storage. Cathedral / Phipps / Warhol / Carnival
 * use the team's real JPEGs from User_Photos/; the rest are labelled cards.
...
export const DEMO_PHOTO_SPECS: DemoPhotoSpec[] = [
  {
    ...
    caption: 'Looking straight up the Gothic tower from the courtyard, flowers around the fountain.',
  ...
  // 20:30 is outside the Phipps window ±2h → exercises the same-day nearest-pin fallback
  {
    ...
    label: 'Phipps Conservatory · 20:30',
