...
describe('naive time helpers', () => {
  ...
  it('windows and days', () => {
    expect(withinWindow('2026-09-11T09:15:00', '2026-09-11T10:00:00', '2026-09-11T11:00:00', 2)).toBe(true);
    expect(withinWindow('2026-09-11T07:59:00', '2026-09-11T10:00:00', '2026-09-11T11:00:00', 2)).toBe(false);
